            ...
            <section className="section-padding bg-navy-950">
                <div className="container-custom">
                    <div className="max-w-3xl mx-auto bg-navy-900 rounded-2xl border border-navy-800 p-8 sm:p-10">
                        ...
                        <a
                            href={`mailto:connor@regionsystemsllc.com?subject=${quoteSubject}&body=${quoteBody}`}
                        ...
                        <div className="mt-8 space-y-4">
                            <div className="flex items-start gap-3 text-navy-300">
                                ...
                                <a href="mailto:connor@regionsystemsllc.com" className="hover:text-accent-300 transition-colors duration-300">
